...
class Mongo:
    ...
    def insert_video(self, video_path, output_path, frame_folder):
        self.video_meta.insert_one({'video_path': video_path, 'output_path': output_path, 'frame_folder': frame_folder})

    def insert_figure(self, figure_path, times):
        self.figure_meta.insert_one({'path': figure_path, 'times': times})
